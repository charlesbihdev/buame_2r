    ...
    return (
        ...
        >
            ...
            <div className="flex flex-1 flex-col">
                <div className="mb-2">
                    <h3 className="text-lg font-bold text-[#0d1b0d] dark:text-white">{rental.name}</h3>
                </div>
                ...
                <div className="mt-auto space-y-2 border-t border-gray-100 pt-3 dark:border-gray-800">
                    ...
                    <button className="w-full rounded-lg border border-[#13ec13] bg-transparent px-4 py-2 text-xs font-semibold text-[#13ec13] transition-colors hover:bg-[#13ec13] hover:text-[#0d1b0d]">
                        View Details
                    </button>
                </div>
            </div>
