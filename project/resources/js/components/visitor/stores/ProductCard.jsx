        ...
        >
            ...
            <div className="p-4">
                <div className="mb-2 flex items-start justify-between gap-2">
                    <h3 className="line-clamp-2 flex-1 font-bold text-[#0d1b0d] group-hover:text-[#13ec13] dark:text-white">
                        {product.title}
                    </h3>
                    {product.condition && (
                ...
                <div className="mb-2 flex items-center gap-1">
                    ...
                    {product.price_type && (
                        <span className="text-sm text-gray-600 dark:text-gray-400">{product.price_type}</span>
                    )}
                </div>
