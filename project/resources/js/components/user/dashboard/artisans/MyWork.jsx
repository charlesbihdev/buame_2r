...
export function Portfolio({ profile }) {
    ...
    return (
        <div className="space-y-6">
            <div>
                <h2 className="text-2xl font-bold text-[#0d1b0d] dark:text-white">Portfolio</h2>
                <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">Showcase your completed work</p>
            </div>

            <div className="flex items-center justify-between">
                <h3 className="text-lg font-bold text-[#0d1b0d] dark:text-white">My Portfolio</h3>
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    {portfolio.map((item) => (
                        ...
                        >
                            ...
                            <div className="p-4">
                                <p className="font-semibold text-[#0d1b0d] dark:text-white">{item.item || 'Work Item'}</p>
                            </div>
                        </div>
                    ))}
                </div>
