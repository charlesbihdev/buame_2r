            ...
            <div className="flex min-h-screen items-center justify-center bg-[#f6f8f6] px-4 py-12 dark:bg-[#102210]">
                <div className="w-full max-w-4xl">
                    <div className="mb-8 text-center">
                        <h1 className="text-3xl font-bold text-[#0d1b0d] dark:text-white">Choose Your Category</h1>
                            ...
                            {categories.map((category) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`group relative flex flex-col items-center gap-4 rounded-xl border-2 p-6 transition-all hover:border-[#13ec13] hover:bg-[#13ec13]/5 ${
                                            isSelected
                                    ...
                                    >
                                        {isSelected && (
                                            <div className="absolute right-3 top-3 flex h-6 w-6 items-center justify-center rounded-full bg-[#13ec13]">
                                        ...
                                        <div
                                            className={`flex h-16 w-16 items-center justify-center rounded-full transition-colors ${
                                                isSelected ? 'bg-[#13ec13] text-white' : 'bg-gray-100 text-gray-600 dark:bg-gray-700 dark:text-gray-300'
                                            }`}
                                        >
                                        ...
                                        <div className="text-center">
                                            <h3 className="text-lg font-bold text-[#0d1b0d] dark:text-white">{category.label}</h3>
                                            <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">{category.description}</p>
                                            <p className="mt-2 text-lg font-bold text-[#13ec13]">GH₵ {category.price}</p>
                                        </div>
                                    </button>
                                );
                            })}
