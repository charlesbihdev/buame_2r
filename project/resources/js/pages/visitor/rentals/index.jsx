...
import { Car, Home, MapPin, Search, Store, Tractor, Wrench } from 'lucide-react';
        ...
        <VisitorLayout>
            ...
            <div className="border-b border-gray-200 bg-white dark:border-gray-800 dark:bg-[#0d1b0d]">
                <div className="mx-auto max-w-7xl px-4 py-12 md:px-8">
                    <h1 className="mb-8 text-center text-4xl font-black text-[#0d1b0d] md:text-5xl dark:text-white">Rent Anything in Sefwi Bekwai</h1>

                    {/* Search Bar */}
                    <div className="mx-auto max-w-4xl">
                        <form onSubmit={handleSearch} className="mb-4 flex flex-col gap-3 rounded-xl bg-gray-50 p-4 md:flex-row dark:bg-[#162816]">
                            <div className="flex flex-1 items-center gap-3 rounded-lg border border-gray-200 bg-white px-4 py-3 dark:border-gray-700 dark:bg-[#0d1b0d]">
                                ...
                                <input
                                    ...
                                    className="w-full border-none bg-transparent p-0 text-sm focus:ring-0 focus:outline-none dark:text-white"
                                />
                            </div>
                            <div className="flex items-center gap-3 rounded-lg border border-gray-200 bg-white px-4 py-3 md:w-48 dark:border-gray-700 dark:bg-[#0d1b0d]">
                            ...
                            {rentals.map((rental) => (
                                ...
                                >
                                    ...
                                    <div className="relative h-48 overflow-hidden bg-gray-200">
                                        ...
                                        <div className="absolute top-3 right-3 rounded-full bg-[#13ec13] px-3 py-1 text-xs font-bold text-[#0d1b0d]">
