    ...
    return (
        <section className="relative w-full bg-[#1a2e1a] py-16 md:py-24">
            ...
            <div className="relative z-10 mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
                <h1 className="mb-6 text-4xl font-black tracking-tight text-white md:text-5xl lg:text-6xl">Get in Touch with 2RBUAME</h1>
                <p className="mx-auto max-w-2xl text-lg leading-relaxed font-medium text-gray-200 md:text-xl">
                    Connecting Western North and beyond. Have a question about finding a local artisan or listing your business? We are here to help you navigate
                    the marketplace, welcoming customers from all backgrounds.
                </p>
            </div>
        </section>
    );
