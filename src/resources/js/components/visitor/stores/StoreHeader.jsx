...
export function StoreHeader({ store }) {
    ...
    return (
        <header className="sticky top-0 z-50 border-b border-gray-200 bg-white/95 backdrop-blur-sm dark:border-gray-800 dark:bg-[#0d1b0d]/95">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex items-center gap-2">
                            <div className="flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-br from-[#13ec13] to-[#0fdc0f]">
                                <Store className="h-4 w-4 text-white" />
                            </div>
                            <span className="font-bold text-[#0d1b0d] dark:text-white">{store.name}</span>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        {store.user?.phone && (
                            <a
                                ...
                                className="flex h-9 w-9 items-center justify-center rounded-full bg-gray-100 text-gray-600 transition-colors hover:bg-[#13ec13]/10 hover:text-[#13ec13] dark:bg-gray-800 dark:text-gray-400"
                                title="Call store"
                            >
                        ...
                        <div className="relative">
                            <button
                                ...
                                className="flex h-9 items-center gap-2 rounded-full bg-[#13ec13] px-4 font-semibold text-[#0d1b0d] transition-colors hover:bg-[#0fdc0f]"
                            >
                            ...
                            {/* Share Dropdown */}
                            {showShareMenu && (
                                <div className="absolute right-0 top-full mt-2 w-48 rounded-xl border border-gray-200 bg-white p-2 shadow-lg dark:border-gray-700 dark:bg-[#162816]">
                                    <button
                                    ...
                                    >
                                        {copied ? (
                                            <Check className="h-4 w-4 text-[#13ec13]" />
                                        ) : (
