...
export function StoreEmptyState({ hasFilters, onClearFilters, storeName }) {
    if (hasFilters) {
        return (
            <div className="flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-gray-200 bg-white px-6 py-16 text-center dark:border-gray-700 dark:bg-[var(--card)]">
                ...
                <h3 className="mb-2 text-xl font-bold text-[var(--foreground)] dark:text-white">No products match your search</h3>
    ...
    return (
        <div className="flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-gray-200 bg-white px-6 py-16 text-center dark:border-gray-700 dark:bg-[var(--card)]">
            ...
            <h3 className="mb-2 text-xl font-bold text-[var(--foreground)] dark:text-white">No products yet</h3>
