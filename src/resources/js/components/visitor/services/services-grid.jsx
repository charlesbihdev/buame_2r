...
export function ServicesGrid() {
    const services = [
        ...
        },
        {
            ...
            title: 'Hotel',
            description: 'Discover comfortable hotels and guest houses for short or long stays across Western North and beyond.',
        ...
        },
        {
            ...
            category: 'Property',
            title: 'Rentals',
            description: 'Find houses, apartments, and commercial spaces for rent across Western North and beyond.',
        ...
        },
        {
            ...
            title: 'Jobs',
            description:
                'Connect with local employers or find your next hire. Whether you need farm hands, shop assistants, or office staff, 2RBUAME bridges the gap between talent and opportunity.',
