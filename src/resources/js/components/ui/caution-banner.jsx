...
export function CautionBanner({ type = 'general', className = '' }) {
    ...
    return (
        <div className={`relative overflow-hidden rounded-xl border-2 border-amber-200 bg-gradient-to-r from-amber-50 to-yellow-50 dark:border-amber-800/50 dark:from-amber-950/30 dark:to-yellow-950/30 ${className}`}>
            ...
            <div className="relative p-5 md:p-6">
                ...
                <div className="flex items-start justify-between gap-4">
                    <div className="flex items-start gap-3 flex-1">
                        <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-lg bg-amber-400/20 dark:bg-amber-400/10">
                            <ShieldCheck className="h-5 w-5 text-amber-700 dark:text-amber-400" />
                        </div>
                        <div className="flex-1">
                            <div className="flex items-center gap-2">
                                <h3 className="text-base font-bold text-amber-900 dark:text-amber-100 md:text-lg">
                    ...
                    <button
                        ...
                        className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-lg text-amber-700 transition-colors hover:bg-amber-200/50 dark:text-amber-400 dark:hover:bg-amber-800/30"
                        ...
                        <ul className="space-y-2">
                            {cautionData.points.map((point, index) => (
                                <li key={index} className="flex items-start gap-2 text-sm text-amber-900 dark:text-amber-100">
                                    <span className="mt-1 flex h-1.5 w-1.5 flex-shrink-0 rounded-full bg-amber-600 dark:bg-amber-400"></span>
                                    <span>{point}</span>
                                </li>
                            ))}
                        </ul>

                        <div className="mt-4 rounded-lg bg-amber-100/50 p-3 dark:bg-amber-900/20">
                ...
                <div className="mt-4 flex justify-center">
                    <Button
                        ...
                        variant="ghost"
                        size="sm"
                        className="gap-2 text-amber-800 hover:bg-amber-200/50 hover:text-amber-900 dark:text-amber-200 dark:hover:bg-amber-800/30 dark:hover:text-amber-100"
                    >
                        {isExpanded ? (
                            <>
                                Show Less
