...
export default function BillingCycleSelector({ selected, onChange, pricing }) {
    ...
    return (
        <div className="space-y-3">
            <h3 className="text-sm font-bold text-gray-700">Select Billing Cycle</h3>
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="flex flex-col items-center gap-1 pt-1">
                                ...
                                <span className="text-sm font-semibold text-[var(--foreground)]">{cycle.label}</span>
                                <span className="text-lg font-bold text-[var(--primary)]">GH₵ {price?.toFixed(2) || '0.00'}</span>
                                {cycle.key !== 'monthly' && monthlyEquiv && (
                                    <span className="text-[10px] text-gray-500">GH₵ {monthlyEquiv}/mo</span>
                                )}
                            </div>
                        </button>
                    );
