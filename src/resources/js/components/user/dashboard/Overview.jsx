        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                <div className="rounded-xl border border-[var(--buame-border-light)] dark:border-[#2a4d2a] bg-white dark:bg-[#1a331a] p-6">
                    ...
                    <p className="mt-2 text-3xl font-bold text-[var(--foreground)] dark:text-white">{stats.total || 0}</p>
                </div>
                ...
                <div className="rounded-xl border border-[var(--buame-border-light)] dark:border-[#2a4d2a] bg-white dark:bg-[#1a331a] p-6">
                    ...
                    <p className="mt-2 text-3xl font-bold text-[var(--foreground)] dark:text-white">{stats.active || 0}</p>
                </div>
                ...
                <div className="rounded-xl border border-[var(--buame-border-light)] dark:border-[#2a4d2a] bg-white dark:bg-[#1a331a] p-6">
                    ...
                    <p className="mt-2 text-3xl font-bold text-[var(--foreground)] dark:text-white">{stats.views || 0}</p>
                </div>
            </div>
        </div>
    );
