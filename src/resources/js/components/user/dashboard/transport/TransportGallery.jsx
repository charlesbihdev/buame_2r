...
export function TransportGallery({ profile }) {
    ...
    return (
        <div className="space-y-6">
            <div>
                <h2 className="text-2xl font-bold text-[var(--foreground)]">Vehicle Gallery</h2>
                <p className="mt-1 text-sm text-gray-600">Manage your vehicle images and showcase your service</p>
            </div>

            <div className="flex items-center justify-between">
                <h3 className="text-lg font-bold text-[var(--foreground)]">Vehicle Images</h3>
