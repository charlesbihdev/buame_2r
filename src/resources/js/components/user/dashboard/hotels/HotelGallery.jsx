...
export function HotelGallery({ profile }) {
    ...
    return (
        <div className="space-y-6">
            <div>
                <h2 className="text-2xl font-bold text-[var(--foreground)] dark:text-white">Hotel Gallery</h2>
                <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">Manage your hotel images and showcase your property</p>
            </div>

            <div className="flex items-center justify-between">
                <h3 className="text-lg font-bold text-[var(--foreground)] dark:text-white">Property Images</h3>
                <Button onClick={handleAdd} className="bg-[var(--primary)] text-white hover:bg-[var(--primary)]/90">
            ...
            {otherImages.length > 0 ? (
                ...
                !primaryImage && (
                    <div className="rounded-xl border-2 border-dashed border-gray-300 p-12 text-center dark:border-gray-700">
                        ...
                        <Button onClick={handleAdd} className="mt-4 bg-[var(--primary)] text-white hover:bg-[var(--primary)]/90">
                            <Plus className="mr-2 h-4 w-4" />
