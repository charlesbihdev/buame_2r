...
export function HotelGallery({ profile }) {
    ...
    return (
        <div className="space-y-6">
            <div>
                <h2 className="text-2xl font-bold text-[var(--foreground)]">Hotel Gallery</h2>
                <p className="mt-1 text-sm text-gray-600">Manage your hotel images and showcase your property</p>
            </div>

            <div className="flex items-center justify-between">
                <h3 className="text-lg font-bold text-[var(--foreground)]">Property Images</h3>
