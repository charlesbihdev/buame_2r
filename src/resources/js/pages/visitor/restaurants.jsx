            ...
            <div className="flex grow flex-col lg:flex-row">
                ...
                <main className="flex flex-1 flex-col bg-background-light p-4 md:p-6 lg:p-8">
                    ...
                    <div className="mt-12 flex justify-center">
                        <Button
                            variant="outline"
                            className="flex items-center justify-center gap-2 rounded-lg border border-[var(--buame-border-light)] bg-white px-6 py-3 text-sm font-bold text-gray-700 transition-colors hover:bg-gray-50"
                        >
                        ...
                        <div className="z-10 mt-2 flex w-full max-w-[600px] flex-col">
                            <div className="flex w-full flex-col items-stretch overflow-hidden rounded-lg shadow-xl sm:flex-row">
                                ...
                                <div className="relative flex-1 bg-white">
                                    ...
                                    <input
                                        className="h-12 w-full border-none bg-transparent pl-12 pr-4 text-sm placeholder:text-gray-400 focus:ring-0 sm:h-14"
...
function RestaurantsFilters() {
    return (
        <aside className="hidden min-h-[calc(100vh-80px)] w-80 shrink-0 flex-col gap-8 border-r border-[var(--buame-border-light)] bg-white p-6#2a4e2a] lg:flex">
            ...
            {/* Cuisine Type */}
            <div>
                <h3 className="mb-4 text-base font-bold">Cuisine Type</h3>
                    ...
                    {['All Cuisines', 'Local Ghanaian', 'Fufu & Soup', 'Jollof & Rice', 'Street Food', 'Continental', 'Fast Food'].map(
                        (type) => (
                            <label key={type} className="group flex cursor-pointer items-center gap-3">
                                ...
                                />
                                <span className="text-sm font-medium transition-colors group-hover:text-[var(--primary)]">
                                    {type}
                                </span>
                            </label>
                        ),
            ...
            {/* Price Range */}
            <div>
                <h3 className="mb-4 text-base font-bold">Price Range</h3>
                <div className="flex flex-col gap-3">
            ...
            {/* Meal Type */}
            <div>
                <h3 className="mb-4 text-base font-bold">Meal Type</h3>
                <div className="flex flex-col gap-3">
                    {['Breakfast', 'Lunch', 'Dinner', 'Snacks'].map((meal) => (
                        <label key={meal} className="group flex cursor-pointer items-center gap-3">
                            <input
                                ...
                                className="rounded border-gray-300 bg-transparent text-[var(--primary)] focus:ring-[var(--primary)]"
                            />
                            <span className="text-sm font-medium transition-colors group-hover:text-[var(--primary)]">{meal}</span>
                        </label>
                    ))}
                </div>
            </div>
            ...
            {/* Rating Filter */}
            <div>
                <h3 className="mb-4 text-base font-bold">Rating</h3>
                <div className="flex flex-col gap-2">
                    <label className="flex cursor-pointer items-center gap-2">
                        ...
                        <span className="text-sm">5.0 only</span>
                    </label>
                    <label className="flex cursor-pointer items-center gap-2">
                        <input
                            type="radio"
        ...
        <>
            ...
            <div className="mb-6 flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
                <p className="text-sm font-medium text-gray-500">
                    Showing <span className="font-bold text-[var(--foreground)]">28</span> restaurants across Western North and beyond
                </p>
                <div className="flex w-full items-center gap-3 sm:w-auto">
                    ...
                    <div className="flex rounded-lg border border-[var(--buame-border-light)] bg-white p-1#2a4e2a]">
                        ...
                        <button className="flex size-8 items-center justify-center rounded text-gray-400 hover:text-gray-600">
                            <span className="text-lg">☰</span>
                        </button>
                    </div>
                </div>
                ...
                >
                    ...
                    <div className="flex flex-1 flex-col p-4">
                        <div className="mb-2 flex items-start justify-between">
                            <h4 className="line-clamp-1 text-lg font-bold text-[var(--foreground)]">{restaurant.name}</h4>
