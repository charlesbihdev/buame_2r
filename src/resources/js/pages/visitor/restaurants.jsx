...
export default function Restaurants() {
    return (
        <VisitorLayout>
            <Head title="Restaurants & Food | BUAME 2R" />
            
            {/* Hero Section */}
            <RestaurantsHero />
            
            {/* Toggle Section */}
            <div className="border-b border-[#e7f3e7] bg-background-light px-4 py-4 dark:border-white/10 dark:bg-background-dark md:px-40">
                <div className="mx-auto flex h-12 w-full max-w-md items-center justify-center rounded-xl bg-[#e7f3e7] p-1 dark:bg-[#1a2e1a]">
                    <label className="flex h-full grow cursor-pointer items-center justify-center overflow-hidden rounded-lg px-2 text-[#4c9a4c] transition-all has-[:checked]:bg-white has-[:checked]:text-[#0d1b0d] has-[:checked]:shadow-sm dark:has-[:checked]:bg-background-dark dark:has-[:checked]:text-[#13ec13]">
                    ...
                    >
                        <div className="z-10 flex max-w-2xl flex-col gap-3 text-center">
                            <h1 className="text-3xl font-black leading-tight tracking-[-0.033em] text-white md:text-5xl">
                                Experience Sefwi Bekwai's Best Flavors
                            </h1>
                            <p className="text-sm font-normal text-gray-200 md:text-base">
                                Find the best local food joints, chop bars, and restaurants in the Western North Region.
                            </p>
                        </div>
...
function RestaurantsFilters() {
    return (
        <aside className="hidden min-h-[calc(100vh-80px)] w-80 shrink-0 flex-col gap-8 border-r border-[#e7f3e7] bg-white p-6 dark:border-[#2a4e2a] dark:bg-[#162816] lg:flex">
            {/* Active Filters Summary */}
            <div>
                <h3 className="mb-4 text-sm font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">Active Filters</h3>
                <div className="grid grid-cols-1 overflow-hidden rounded-lg border border-[#e7f3e7] bg-[#f8fcf8] dark:border-[#2a4e2a] dark:bg-[#0d1b0d]">
                    <div className="flex items-center justify-between border-b border-[#e7f3e7] p-3 dark:border-[#2a4e2a]">
                    ...
                    <div className="flex items-center justify-between p-3">
                        ...
                        <span className="text-sm font-medium text-[#13ec13]">Yes</span>
                    </div>
                </div>
            </div>
                    ...
                    {['Breakfast', 'Lunch', 'Dinner', 'Snacks'].map((meal) => (
                        <label key={meal} className="group flex cursor-pointer items-center gap-3">
                            <input
                                ...
                                className="rounded border-gray-300 bg-transparent text-[#13ec13] focus:ring-[#13ec13]"
                            />
                            <span className="text-sm font-medium transition-colors group-hover:text-[#13ec13] dark:text-gray-200">{meal}</span>
                        </label>
                    ))}
                </div>
            </div>
            ...
            <div>
                ...
                <div className="flex flex-col gap-2">
                    <label className="flex cursor-pointer items-center gap-2">
                        <input type="radio" name="rating" className="border-gray-300 bg-transparent text-[#13ec13] focus:ring-[#13ec13]" />
    ...
    return (
        <>
            ...
            <div className="mb-6 flex gap-3 overflow-x-auto pb-2 scrollbar-hide">
                <button className="flex h-9 shrink-0 items-center justify-center gap-x-2 rounded-full bg-[#13ec13] px-4 text-[#0d1b0d] shadow-sm transition-shadow hover:shadow-md">
                ...
                {[
                    ...
                    <button
                        key={item.label}
                        className="flex h-9 shrink-0 items-center justify-center gap-x-2 rounded-full border border-[#e7f3e7] bg-white px-4 transition-colors hover:border-[#13ec13]/50 dark:border-[#2a4e2a] dark:bg-[#162816]"
                    >
            ...
            <div className="mb-6 flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
                <p className="text-sm font-medium text-gray-500 dark:text-gray-400">
                    Showing <span className="font-bold text-[#0d1b0d] dark:text-white">28</span> restaurants in Sefwi Bekwai
                </p>
                <div className="flex w-full items-center gap-3 sm:w-auto">
                    {/* Mobile Filter Toggle */}
                    <button className="flex size-10 items-center justify-center rounded-lg border border-[#e7f3e7] bg-white text-gray-700 dark:border-[#2a4e2a] dark:bg-[#162816] dark:text-white lg:hidden">
                        <span className="text-lg">⚙️</span>
                    </button>
                    <div className="relative ml-auto sm:ml-0">
                        <select className="h-10 cursor-pointer rounded-lg border-[#e7f3e7] bg-white pl-3 pr-8 text-sm focus:border-[#13ec13] focus:ring-[#13ec13] dark:border-[#2a4e2a] dark:bg-[#162816] dark:text-white">
                    ...
                    <div className="flex rounded-lg border border-[#e7f3e7] bg-white p-1 dark:border-[#2a4e2a] dark:bg-[#162816]">
                        <button className="flex size-8 items-center justify-center rounded bg-[#13ec13]/20 text-[#13ec13]">
    ...
    return (
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 xl:grid-cols-3">
            {restaurants.map((restaurant, index) => (
                <div
                    key={index}
                    className="group flex flex-col overflow-hidden rounded-xl border border-[#e7f3e7] bg-white transition-shadow hover:shadow-md dark:border-[#2a4e2a] dark:bg-[#162816]"
                >
                    <div className="relative h-48 w-full overflow-hidden bg-gray-200">
                        <div className="absolute left-3 top-3 z-10 flex items-center gap-1 rounded-md bg-white/90 px-2 py-1 text-xs font-bold text-[#0d1b0d] backdrop-blur-sm">
                            <Star className="h-3 w-3 fill-orange-500 text-orange-500" /> {restaurant.rating}
                        </div>
                        {restaurant.badge && (
                            <div className="absolute right-3 top-3 z-10 rounded-md bg-[#13ec13] px-2 py-1 text-xs font-bold text-[#0d1b0d]">
                                {restaurant.badge}
                            </div>
                        )}
                        <div
                    ...
                    <div className="flex flex-1 flex-col p-4">
                        <div className="mb-2 flex items-start justify-between">
                            <h4 className="line-clamp-1 text-lg font-bold text-[#0d1b0d] dark:text-white">{restaurant.name}</h4>
                        ...
                        <div className="mt-auto flex gap-2">
                            <button className="flex-1 rounded-lg bg-[#e7f3e7] py-2.5 text-sm font-bold text-[#0d1b0d] transition-colors hover:bg-[#d6ebd6] dark:bg-[#1a2e1a] dark:text-white dark:hover:bg-[#233d23]">
                                View Menu
                            </button>
                            <button className="flex w-10 items-center justify-center rounded-lg bg-[#13ec13] text-[#0d1b0d] transition-colors hover:bg-green-400">
