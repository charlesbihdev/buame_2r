...
class HotelsController extends Controller
{
    ...
    public function update(Request $request, Hotel $hotel): RedirectResponse
    {
        ...
        $validated = $request->validate([
            ...
            'description' => ['nullable', 'string'],
            'operating_hours_mode' => ['required', 'string', 'in:disabled,24_7,custom'],
            'check_in_time' => ['nullable', 'required_if:operating_hours_mode,custom', 'date_format:H:i'],
            'check_out_time' => ['nullable', 'required_if:operating_hours_mode,custom', 'date_format:H:i'],
            'is_active' => ['boolean'],
            'amenities' => ['nullable', 'array'],
            'amenities.*' => ['string', 'max:255'],
            'features' => ['nullable', 'array'],
        ...
        $hotel->update([
            ...
            'operating_hours_mode' => $validated['operating_hours_mode'],
            'check_in_time' => $validated['operating_hours_mode'] === 'custom' ? ($validated['check_in_time'] ?? null) : null,
            'check_out_time' => $validated['operating_hours_mode'] === 'custom' ? ($validated['check_out_time'] ?? null) : null,
